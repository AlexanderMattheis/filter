...
fn create_and_save_histogram(histogram_data: &[f64; NUM_OF_VALUES], y_range_max: f64, logarithmic: bool, color: &str, output_filepath_prefix: &String) {
    let trace = Bar::new(
        (0..NUM_OF_VALUES).collect(),
